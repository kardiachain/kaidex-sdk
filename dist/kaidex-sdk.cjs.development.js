...
var KardiaClient = require('kardia-js-sdk');
var KardiaClient__default = _interopDefault(KardiaClient);
...
var validatePath = function validatePath(path) {
  if (!path || !path.length || !path[0] || !KardiaClient.KardiaAccount.isAddress(path[0]) || !path[1] || !KardiaClient.KardiaAccount.isAddress(path[1])) throw new Error('Invalid token address!');
};
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(tokenA, tokenB) {
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (!(!KardiaClient.KardiaAccount.isAddress(tokenA) || !KardiaClient.KardiaAccount.isAddress(tokenB))) {
                  _context.next = 2;
                  break;
                }
...
var KRC20Service = /*#__PURE__*/function (_AbstractSmcService) {
  ...
  function KRC20Service() {
      ...
      var _ref = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(tokenAddress, walletAddress, spenderAddress) {
        ...
        return runtime_1.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (KardiaClient.KardiaAccount.isAddress(tokenAddress)) {
                  _context.next = 2;
                  break;
                }
              ...
              case 2:
                if (KardiaClient.KardiaAccount.isAddress(walletAddress)) {
                  _context.next = 4;
                  break;
                }
    ...
    _this.balanceOf = function (tokenAddress, walletAddress) {
      if (!KardiaClient.KardiaAccount.isAddress(tokenAddress)) throw new Error('Invalid token Address');
      if (!KardiaClient.KardiaAccount.isAddress(walletAddress)) throw new Error('Invalid wallet address');
      return _this.smcCallData({
        abi: _this.abi,
...
var cellValue = function cellValue(kaiValue, decimals) {
  ...
  var rawValue = new bignumber_js.BigNumber(kaiValue);
  return rawValue.multipliedBy(new bignumber_js.BigNumber(Math.pow(10, decimals))).toFixed(0, 1);
};
...
var KaidexService = /*#__PURE__*/function () {
  function KaidexService(options) {
    ...
    this.transformAddLiquidityParams = function (params) {
      ...
      if (!KardiaClient.KardiaAccount.isAddress(walletAddress)) throw new Error('Invalid wallet address');
      if (!KardiaClient.KardiaAccount.isAddress(tokenA.tokenAddress) || !KardiaClient.KardiaAccount.isAddress(tokenB.tokenAddress)) throw new Error('Invalid token address');
    ...
    this.transformAddLiquidityKAIParams = function (params) {
      ...
      if (!KardiaClient.KardiaAccount.isAddress(walletAddress)) throw new Error('Invalid wallet address');
      if (!KardiaClient.KardiaAccount.isAddress(tokenA) || !KardiaClient.KardiaAccount.isAddress(tokenB)) throw new Error('Invalid token address');
    ...
    this.kardiaClient = new KardiaClient__default({
...
exports.KRC20Service = KRC20Service;
exports.KaidexClient = KaidexClient;
exports.Utils = Utils;
exports.default = KaidexClient;
//# sourceMappingURL=kaidex-sdk.cjs.development.js.map
